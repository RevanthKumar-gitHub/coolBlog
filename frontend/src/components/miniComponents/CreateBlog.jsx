...
const CreateBlog = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const { data } = await axios.post("/blogs/createBlog", formData);
      if (data.success) {
    ...
    <div className="py-4 dark:bg-gray-800">
      ...
      >
        ...
        <textarea
          ...
          className="outline-none border-black  border-b-2 bg-transparent px-2 py-1 h-10"
        />
        <br />
        ...
        {imagePreview.para_one_image_preview ? (
          <img src={imagePreview.para_one_image_preview} />
        ) : (
          ""
        )}
        ...
        {imagePreview.para_two_image_preview ? (
          <img src={imagePreview.para_two_image_preview} />
        ) : (
          ""
        )}
